...
class TubeTest {
    ...
    void testGetNormal() {
        ...
        Tube tube1 = new Tube(new Ray(new Point3D(0, 0, 0), new Vector(1, 0, 0)), 1);
        Vector answer1 = new Vector(0, 1, 0);
        assertEquals(tube1.getNormal(new Point3D(1, 1, 0)), answer1,
                "the getNormal function for tube does not work correctly");
        // =============== Boundary Values Tests ==================
        // TC01: checks if getNormal for tube function works correctly on when we ask for vertical point
        Tube tube2 = new Tube(new Ray(new Point3D(0, 0, 0), new Vector(1, 0, 0)), 1);
        Vector answer2 = new Vector(0, 1, 0);
        assertEquals(tube2.getNormal(new Point3D(0, 1, 0)), answer2,
                "the getNormal function for tube does not work correctly when sent vertical point");
    ...
    void testFindGeoIntersections() {
        ...
        assertNull(tube1.findGeoIntersections(ray), "Must not be intersections");
        ...
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(0.4, 0.2, 0.2)), new GeoPoint(tube2,new Point3D(2, 1, 1))), result, "Bad intersections");
        ...
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(2, 1, 1))), result, "Bad intersections");
        ...
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(0.4, 0.2, 2)), new GeoPoint(tube2,new Point3D(2, 1, 2))), result, "Bad intersections");
        // TC26: Ray starts at the surface and goes inside (1 point)
        ray = new Ray(new Point3D(0.4, 0.2, 2), new Vector(2, 1, 0));
        result = tube2.findGeoIntersections(ray);
        assertNotNull(result, "must be intersections");
        assertEquals(1, result.size(), "must be 1 intersections");
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(2, 1, 2))), result, "Bad intersections");
        ...
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(1, 0, 2)), new GeoPoint(tube2,new Point3D(1, 2, 2))), result, "Bad intersections");
        // TC31: Ray starts at the surface and goes inside and crosses the axis
        ray = new Ray(new Point3D(1, 0, 2), new Vector(0, 1, 0));
        result = tube2.findGeoIntersections(ray);
        assertNotNull(result, "must be intersections");
        assertEquals(1, result.size(), "must be 1 intersections");
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(1, 2, 2))), result, "Bad intersections");
        ...
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(0.4, 0.2, 1)),new GeoPoint(tube2, new Point3D(2, 1, 1))), result, "Bad intersections");
        ...
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(1, 0, 1)), new GeoPoint(tube2,new Point3D(1, 2, 1))), result, "Bad intersections");
        ...
        assertNotNull(result, "must be intersections");
        assertEquals(1, result.size(), "must be 1 intersections");
        assertEquals(List.of(new GeoPoint(tube2, new Point3D(1, 2, 1))), result, "Bad intersections");
        ...
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(2, 1, 2)), new GeoPoint(tube2,new Point3D(0.4, 1.8, 1.2))), result, "Bad intersections");
        // TC63: Ray's line crosses the tube and begins at surface and goes inside
        ray = new Ray(new Point3D(0.4, 1.8, 1), new Vector(2, -1, 1));
        result = tube2.findGeoIntersections(ray);
        assertNotNull(result, "must be intersections");
        assertEquals(1, result.size(), "must be 1 intersections");
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(2, 1, 1.8))), result, "Bad intersections");
        // TC64: Ray's line crosses the tube and begins inside
        ray = new Ray(new Point3D(1, 1.5, 1), new Vector(2, -1, 1));
        result = tube2.findGeoIntersections(ray);
        assertNotNull(result, "must be intersections");
        assertEquals(1, result.size(), "must be 1 intersections");
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(2, 1, 1.5))), result, "Bad intersections");
        ...
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(value1, value1, 2 + value1)), new Point3D(value2, value2, 2 + value2)),
                result,
                "Bad intersections");
        ...
        if (result.get(0).point.getY() > result.get(1).point.getY())
            result = List.of(result.get(1), result.get(0));
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(value1, value1, value1)), new GeoPoint(tube2,new Point3D(value2, value2, value2))),
                result,
                "Bad intersections");
        ...
        assertNotNull(result, "must be intersections");
        assertEquals(1, result.size(), "must be 1 intersections");
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(value2, value2, 2 + value2))), result, "Bad intersections");
        ...
        assertNotNull(result, "must be intersections");
        assertEquals(1, result.size(), "must be 1 intersections");
        assertEquals(List.of(new GeoPoint(tube2,new Point3D(value2, value2, value2))), result, "Bad intersections");
